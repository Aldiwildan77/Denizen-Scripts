...
#                - yaml id:super-counter set energy.<context.caster.uuid>:<yaml[super-counter].read[energy.<context.caster.uuid>].sub[<[cost]>]>
                ...
                - define mobs <[caster].location.find.entities.within[15].exclude[<[caster].location.find.entities[player].within[15]>]>
                - define players <[caster].location.find.entities[player].within[15]>
