UnlockTenacityQuestDeliveryHandler:
    type: task
    debug: false
    script:
    - define stage:1
...
UnlockTenacityCompletion:
    ...
    debug: false
    script:
    - execute as_server "cast teach <player.name> Tenacity"