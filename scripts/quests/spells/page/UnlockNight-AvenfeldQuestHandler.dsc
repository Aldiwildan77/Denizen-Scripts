UnlockNight-AvenfeldQuestDeliveryHandler:
    type: task
    debug: false
    script:
    - define stage:1
    - define quest_internalname:UnlockNight-Avenfeld
    - choose <player.item_in_hand.material.name>:
        ...
        - case default:
            ...
            - run QuestProgressHandler def:UnlockNight-Avenfeld
            - stop
...
UnlockNight-AvenfeldCompletion:
    ...
    debug: false
    script:
    - execute as_server "cast teach <player.name> Night-Avenfeld"
