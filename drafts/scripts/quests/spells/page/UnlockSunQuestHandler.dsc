UnlockSunQuestDeliveryHandler:
    type: task
    debug: false
    script:
    - define stage:1
    - define quest_internalname:UnlockSun
...
UnlockSunCompletion:
    ...
    debug: false
    script:
    - execute as_server "cast teach <player.name> Sun"