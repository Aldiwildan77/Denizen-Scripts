"Champion Handler":
    ...
    events:
        ...
        - if <server.has_flag[champion_spawner_<[world]>]> && <server.flag[champion_spawner_<[world]>]> >= 500 && !<server.flag[champion_recent_<[world]>]>:
            ...
            - title "title:<yellow>CHAMPION SUMMONED" "subtitle:Prepare for battle!" fade_in:1s stay:2s fade_out:1s targets:<w@<[world]>.players>
            ...
            - define location <context.damager.location.find.surface_blocks.within[10].last> world:<[world]>
