UnlockIceblockQuestDeliveryHandler:
    type: task
    debug: false
    script:
    - define stage:1
    - define quest_internalname:UnlockIceblock
...
UnlockIceblockCompletion:
    type: task
    debug: false
    script:
    - execute as_server "cast teach <player.name> Iceblock"