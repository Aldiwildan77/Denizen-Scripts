UnlockGustQuestDeliveryHandler:
    type: task
    debug: false
    script:
    - define stage:1
...
UnlockGustCompletion:
    type: task
    debug: false
    script:
    - execute as_server "cast teach <player.name> Gust"