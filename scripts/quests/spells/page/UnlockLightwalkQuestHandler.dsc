UnlockLightwalkQuestDeliveryHandler:
    type: task
    debug: false
    script:
    - define stage:1
...
UnlockLightwalkCompletion:
    type: task
    debug: false
    script:
    - execute as_server "cast teach <player.name> Lightwalk"